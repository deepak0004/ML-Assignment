...
thee1 = Theta1.*Theta1;
thee2 = Theta2.*Theta2;
regu1 = sum( sum( thee1(:, 2:end) ) ); % Not including the bias
regu2 = sum( sum( thee2(:, 2:end) ) );
regu = ( regu1 + regu2 ) * lambda; 
regu = regu / ( 2*m );
...
for t = 1:m
    ...
    io = zeros(num_labels, 1);
    io( y(t) ) = 1;
    
    delta3 = a3 - io;                             % 10*1 
    delta2 = (Theta2' * delta3);                  % 26*1
    delta2 = delta2.*[1; sigmoidGradient( z2 )];  % 26*1        
